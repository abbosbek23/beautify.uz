        ...
        >
          ...
          >
            ...
            >
              <Grid xs={12} sm={6}>
            <Box
            className={emailverification ? "emailverification box-signin":"emailverification2 box-signin"}
              height="100%"
            >
              <Typography component="h1" variant="h4" sx={{ marginTop: "32px" }}>
              Sign Up
              </Typography>
              
              <Box sx={{marginTop: "42px", paddingLeft: "60px", paddingRight: "60px", }}>
                <form className="form-group resume-box" onSubmit={handleSubmit(onsubmit)} id="register" >
                  <input className="login-form" type="text"
                    {...register("full_name", {
                  ...
                  <input
                    ...
                    })} className="login-form" type="email" placeholder="Elektron pochta manzilingiz"
                  />
                  {errors.email && (
                  ...
                  <input
                    ...
                    })} className="login-form" type="text" placeholder="Foydalanuvchi nomi"
                  />
                  {errors.username && (
                  ...
                  {emailverification ? (
                    <> <input {...register("activate_code", {
                        ...
                        type="number" placeholder="Activation Code"
                        
                      />
                      {errors.activate_code && (
                        <p style={{ color: "red" }}>{`${errors.activate_code.message}`}</p>
                      )}
                    </>
                  ) : (
                    ""
